...
//- {this.props.data.allShifts.nodes.length}
    return(
      ...
      <Header as = 'h1' style={{textAlign: 'center' , color: '#0022A1'}} >
        ADD SHIFT Total Shifts- {this.props.data.allShifts.nodes.length}
        <Image
          floated="left"
...
`
const getShiftFormWithData = graphql(getShiftQuery)(AddShiftForm)
export default  getShiftFormWithData;