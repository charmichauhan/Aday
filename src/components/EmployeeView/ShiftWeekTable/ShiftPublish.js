        ...
        return(
            <div>
                ...
                <div className="btn-action">
                    ...
                    <Button className="btn-image flr" as={NavLink} to="/schedule/employeeview/template"><img className="btn-image flr" src="/assets/Buttons/template-list-button.png" alt="Template List"/></Button>
                </div>
            </div>
        )
    }
